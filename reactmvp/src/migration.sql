...
('BERSERK 1997', 'Berserk is a dark fantasy manga and anime series that follows the story of a mercenary named Guts who is seeking revenge against his former friend and leader, Griffith, who betrayed and sacrificed their comrades to become a powerful demon.', NULL),
('KONOSUBA', 'Following an untimely and embarrassing death, Kazuma Satou, a Japanese teenage shut-in NEET, meets a goddess named Aqua, who offers to reincarnate him in a parallel world with MMORPG elements, where he can go on adventures and battle monsters.', NULL),
...
('PARASYTE', '17-year-old Shinichi Izumi is partially infected by a Parasyte, monsters that butcher and consume humans. He must learn to co-exist with the creature if he is to survive both the life of a Parasyte and a human as part monster, part person.', NULL);
