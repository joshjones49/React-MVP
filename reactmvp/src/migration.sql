...
('BERSERK 1997', 'Berserk is a dark fantasy manga and anime series that follows the story of a mercenary named Guts who is seeking revenge against his former friend and leader, Griffith, who betrayed and sacrificed their comrades to become a powerful demon.', 'https://github.com/joshjones49/React-MVP/blob/main/reactmvp/src/images/berserk-image.jpg?raw=true'),
('KONOSUBA', 'Following an untimely and embarrassing death, Kazuma Satou, a Japanese teenage shut-in NEET, meets a goddess named Aqua, who offers to reincarnate him in a parallel world with MMORPG elements, where he can go on adventures and battle monsters.', 'https://github.com/joshjones49/React-MVP/blob/main/reactmvp/src/images/konosuba-image.jpg?raw=true'),
